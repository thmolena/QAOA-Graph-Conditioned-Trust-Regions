...
\begin{table*}[t]
\centering
\caption{\textbf{Confirmatory results by graph family.}  Lower utility is better
...
\begin{table*}[t]
\centering
\caption{\textbf{Locked confirmatory policy comparison.}  Lower AURC is better,
and every difference is measured against the family fallback on the same 160
audit graphs.  The oracle is retrospective and unavailable at deployment.}
\label{tab:policy-comparison}
\resizebox{\textwidth}{!}{\input{tables/table_policy_comparison.tex}}
\end{table*}
